...
def build_model(args):
    ...
    pytorch_state_dict = pytorch.load("../../expr/checkpoints/afhq/100000_nets_ema.pt",
    ...
    y = np.random.randint(0,3, batch_size2).astype("int32")
    ...
    with fluid.dygraph.guard(place=place):
        ...
        #     torch.load("../../expr/checkpoints/afhq/100000_nets_ema.ckpt/mapping_network.pdparams"))

        nets_ema['mapping_network'].train()
        d_optimizer=fluid.optimizer.AdamOptimizer(learning_rate=1e-4, parameter_list=nets_ema['mapping_network'].parameters())
        ...
        #     d_avg_cost=fluid.layers.mse_loss(out,m_out_train_p) #+fluid.layers.mse_loss(out1,m_out_train_1p)+fluid.layers.mse_loss(out2,m_out_train_2p)
        #
        #
        #     d_avg_cost.backward()
        ...
        #         nets_ema['mapping_network'].train()
        #
        #         # y_train = np.random.randint(0, 3, batch_size).astype("int32")
        ...
        torch.save(nets_ema_state_dict, "../../expr/checkpoints/afhq/100000_nets_ema.ckpt")
        if args.w_hpf > 0:
...
if __name__ == '__main__':
    ...
    args=argparse.Namespace(batch_size=8, beta1=0.0, beta2=0.99,
              ...
              ds_iter=100000, eval_dir='expr/eval/afhq',
              ...
              num_domains=3, num_outs_per_domain=10, num_workers=4, out_dir='assets/representative/celeba_hq/src/female',
              ...
              style_dim=64, total_iters=100000, train_img_dir='data/afhq/train', val_batch_size=32, val_img_dir='data/afhq/val',
              w_hpf=0.0, weight_decay=0.0001, wing_path='expr/checkpoints/wing.ckpt')
